...
opts = Dict([("polym", m), ("tol", tau), ("itmax", itermax), ("chksym", true), ("kmore", 0), ("blk", kwant), ("upb", 2.1+a0), ("nprocs", numprocs), ("procs", workers())])
...
for i = 1:length(sizes)
    ...
    CPUtic()
    #for j = 1:repeat
    evals, eigV, kconv, history = dbchdav(L, kwant, opts)
    #end
